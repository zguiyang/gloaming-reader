...
import { recommendationsQuerySchema } from '@gloaming/shared/recommendations';
...
export const validateRecommendationsQuery = validated('query', recommendationsQuerySchema);
